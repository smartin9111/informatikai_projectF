        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="assets/images/logo-light.png"
                                        alt=""></a></figure>
                        </div>
                        ...
                        <div class="menu-right-content clearfix">
                            <div class="sign-box">
                                <a href="signin.html"><i class="fas fa-user"></i>Bejelentkezés</a>
                            </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    <h4>Kapcsolat</h4>
                    <ul>
                        <li>Kecskemét Fő út 2., Magyarország</li>
                        <li><a href="tel:+8801682648101">+36 30 222 3344</a></li>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget about-widget">
                                ...
                                <div class="text">
                                    <p>Üdvözöljük az Car Servicnél! Cégünk több mint 10 éve áll az ügyfelek
                                        rendelkezésére a gépjárművek javítása és karbantartása terén. Szakértő csapatunk
                                        elkötelezett abban, hogy kiváló minőségű szolgáltatásokat nyújtson minden
                                        ügyfelünknek.
                                    </p>
                                    <p> Az Car Service teljes körű javítási és karbantartási szolgáltatásokat kínál
                                        minden t</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="links-list class">
                                        <li>Általános javítás és karbantartás</li>
                                        <li>Diagnosztika és hibafeltárás</li>
                                        <li>Klímajavítás és töltés</li>
                                        <li>Fékszerviz és javítás</li>
                                        <li>Futómű beállítás és javítás</li>
                                        <li>Elektronikai rendszer javítás és karbantartás</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="info-list clearfix">
                                        <li><i class="fas fa-map-marker-alt"></i>6000 Kecskemét Fő út 2.</li>
                                        <li><i class="fas fa-microphone"></i><a href="tel:+36302223344<">+36 30 222
                                                3344</a></li>
                                        <li><i class="fas fa-envelope"></i><a
                                                href="mailto:carservice@example.com">carservice@example.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        ...
                        <div class="copyright pull-left">
                            <p><a href="index.html">Car Service</a> &copy; 2024 Minden jog fentartva</p>
                        </div>
