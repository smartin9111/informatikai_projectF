...
<body>
    ...
    <div class="boxed_wrapper">
                    ...
                    <div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="assets/images/resource/deals-2.jpg"
                                            alt=""></figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
        ...
        <section class="testimonial-style-two"
            style="background-image: url(assets/images/background/testimonial-1.jpg);">
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme dots-style-one owl-nav-none">
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img
                                                src="assets/images/resource/testimonial-1.jpg" alt="">
                                        </figure>
                                        <h4>Rebeka Dawson</h4>
                            ...
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img
                                                src="assets/images/resource/testimonial-2.jpg" alt="">
                                        </figure>
                                        <h4>Marc Kenneth</h4>
                            ...
                            <div class="content-box">
                                ...
                                <ul class="place-list clearfix">
                                    <li><a href="categories.html">
                                            <h5>Australia</h5><span>(02)</span>
                                        </a></li>
                                    <li><a href="categories.html">
                                            <h5>Bangladesh</h5><span>(13)</span>
                                        </a></li>
                                    <li><a href="categories.html">
                                            <h5>Belgium</h5><span>(05)</span>
                                        </a></li>
                                    <li><a href="categories.html">
                                            <h5>Brazil</h5><span>(04)</span>
                                        </a></li>
                                    <li><a href="categories.html">
                                            <h5>California</h5><span>(07)</span>
                                        </a></li>
                                </ul>
                                <div class="btn-box">
